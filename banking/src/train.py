"""Training script for the banking credit scoring model."""
...
from shared.config import RANDOM_SEED, TEST_SIZE, BANKING_DIR
...
from banking.src.preprocess import (
    NUMERIC_FEATURES,
...
def main():
    data_path = BANKING_DIR / "data" / "credit_data.csv"
    artefacts_dir = BANKING_DIR / "artefacts"
    ...
    print_evaluation_summary(metrics, model_name="Banking Credit Scoring")
    ...
    plot_confusion_matrix(
        ...
        title="Banking Credit Scoring - Confusion Matrix",
    )
    plot_roc_curve(
        y_test,
        metrics["y_proba"],
        output_path=artefacts_dir / "roc_curve.png",
        title="Banking Credit Scoring - ROC Curve",
    )
    plot_feature_importance(
        importance,
        output_path=artefacts_dir / "feature_importance.png",
        title="Banking Credit Scoring - Feature Importance",
    )
